                    ...
                    <div className="events__cardCarrosselContainer">
                      ...
                      <div className="events__limitContent">
                        <div className="events__cardHeader">
                            <span className="events__cardCarousel_dates">
                              {evento.datas} 
                            </span>
                            <span className="events__cardCarousel_time">
                              {evento.hora}
                            </span>
                          </div>
                      ...
                      <div className="events__cardCarrosselContainer_image">
                        <ImgDefault 
                          src={evento.image} 
                          alt={evento.alt} 
                          className="events__imageCardCarousel" 
                          quality={75}
                        />
                      </div>
                      ...
                      <div className="events__hoverCard">
                          <TextDefault
                            className="hoverCard_description"
                            text={evento.descricaoHover}
                          />
                          <ButtonLink
